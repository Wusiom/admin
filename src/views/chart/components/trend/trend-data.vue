  ...
  <div class="trend-data-container">
    ...
    <div class="item">
      ...
      <div class="item-amount">
        <span class="item-amount-number" ref="tadayAddedTarget">{{
          data.tadayAdded
        }}</span>
        {{ $t('msg.chart.unit') }}
      </div>
    ...
    <div class="item">
      ...
      <div class="item-amount">
        <span class="item-amount-number" ref="tadayExpendTarget">{{
          data.tadaySub
        }}</span>
        {{ $t('msg.chart.unit') }}
      </div>
    ...
    <div class="item">
      ...
      <div class="item-amount">
        <span class="item-amount-number" ref="tadayBalanceTarget">{{
          data.tadayAmount
        }}</span>
        {{ $t('msg.chart.unit') }}
      </div>
...
onMounted(() => {
  ...
  titleAmountTarget.value = new CountUp(
    titleAmountTarget.value,
    props.data.allAmount,
    options
  ).start()
  tadayAddedTarget.value = new CountUp(
    tadayAddedTarget.value,
    props.data.tadayAdded,
    options
  ).start()
  tadayExpendTarget.value = new CountUp(
    tadayExpendTarget.value,
    props.data.tadaySub,
    options
  ).start()
  tadayBalanceTarget.value = new CountUp(
